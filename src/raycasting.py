...
class RayCasting:
    """
    Motor de Raycasting.
    Calcula a projeção 3D baseada no mapa 2D e posição do jogador.
    """
        ...
        for ray in range(NUM_RAYS):
            ...
            for i in range(MAX_DEPTH):
                ...
                depth_hor += delta_depth
                 ...
                 depth_hor = 20 # Arbitrary large number if no wall hit
    ...
    def update(self):
        self.ray_cast()
        # self.get_objects_to_render() # Moved to renderer for better separation
